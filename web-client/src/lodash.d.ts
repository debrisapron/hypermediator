...
declare namespace fp {
	...
	interface Static {
		 ...
		 */
		set(path: string, value: any, object: Object): Object;

    merge(dest: Object, source: any): Object;
        ...
        **/
		 ...
		 */
		mapKeys<T>(iteratee: any, object: Object): Dictionary<T>;
		mapKeys<T>(iteratee: any): (object: Object) => Dictionary<T>;
		...
		last(arr: Array<any>): any;

		orderBy(iteratee: any, orders: any, array: List<any>): ReadonlyArray<any>

		flatten(array: List<any>): ReadonlyArray<any>
	}
}
